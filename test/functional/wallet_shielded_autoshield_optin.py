...
"""v0.32.2 fund-preservation: coinbase auto-shielding is opt-in (default off).
...
class WalletShieldedAutoshieldOptInTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Default-off must also apply on wallet unlock")
        wallet.walletlock()
        ...
        self.log.info("Confirmed: with the v0.32.2 default, mined coinbase stays transparent (no auto-shield)")
